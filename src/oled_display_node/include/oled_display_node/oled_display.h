...
// ROS topic name - Consider making this a parameter in the node instead
#define  ROS_TOPIC_DISPLAY_NODE     "display_node" // Kept for direct conversion, parameterization preferred
...
// --- Added definitions based on ROS1 usage ---
